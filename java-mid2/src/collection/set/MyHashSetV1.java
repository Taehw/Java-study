...
public class MyHashSetV1 {
    ...
    public boolean contains(int searchValue){
        ...
        LinkedList<Integer> bucket = buckets[hashIndex]; //해시인덱스의 바구니를 찾음
...
//        list.add(30);
//
//        list.remove(1);              // ✅ remove(int index) → 20 삭제
//        list.remove(Integer.valueOf(30)); // ✅ remove(Object o) → 30 삭제
